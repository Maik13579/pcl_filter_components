...
using Adapter = pcl_filter_type_adapters::ros::PclCloudAdapter<pcl::PointXYZI>;
using NormalCloud = pcl::PointCloud<pcl::Normal>;
using NormalAdapter = pcl_filter_type_adapters::ros::PclCloudAdapter<pcl::Normal>;
...
{
  const auto log_dir = std::filesystem::path{"/tmp/pcl_filter_type_adapters_test_logs"};
